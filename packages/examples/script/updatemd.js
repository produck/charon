...
const zhReadme = fs.readFileSync(path.resolve('../charon/docs/zh/README.md'), 'utf8');
...
const newZhReadme = zhReadme.replace(/bundle-left">[\d\w]+</, `bundle-left">${example2.length}b<`)
	.replace(/bundle-right">[\d\w]+</, `bundle-right">${example3.length}b<`);

fs.writeFileSync(path.resolve('../charon/docs/README.md'), newReadme, 'utf8');
fs.writeFileSync(path.resolve('../charon/docs/zh/README.md'), newZhReadme, 'utf8');